...
export const getApiV1SchemaHolder = <ThrowOnError extends boolean = false>(options?: Options<GetApiV1SchemaHolderData, ThrowOnError>) => (options?.client ?? client).get<GetApiV1SchemaHolderResponses, unknown, ThrowOnError>({ url: '/api/v1/_schema-holder', ...options });
